...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mDetector = GestureDetectorCompat(this, mgListener)
...
class Mygroupview(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    private var linemDetector: GestureDetectorCompat
    init {
        linemgListener = MyGestureListener("這是LinearLayout發送")
        linemDetector = GestureDetectorCompat(context, linemgListener)
    }
...
class Mytext(context: Context, attrs: AttributeSet) :
    ...
    private var textmDetector: GestureDetectorCompat
    init {
        textmgListener = MyGestureListener("這是Text發送")
        textmDetector = GestureDetectorCompat(context, textmgListener)
    }
